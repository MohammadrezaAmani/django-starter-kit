...
urlpatterns = [
    ...
    path("api/", include(steps_router.urls)),
    ...
    path(
        ...
        include(
            [
                path(
                    "pending-content/",
                    CourseViewSet.as_view({"get": "pending_content"}),
                    name="pending-content",
                ),
                path(
                    "flagged-content/",
                    FeedbackViewSet.as_view({"get": "flagged_content"}),
                    name="flagged-content",
                ),
                path(
                    "moderate/<uuid:pk>/",
                    FeedbackViewSet.as_view({"post": "moderate"}),
                    name="moderate-content",
                ),
                path(
                    "user-reports/",
                    UserProgressViewSet.as_view({"get": "user_reports"}),
                    name="user-reports",
                ),
            ]
        ),
